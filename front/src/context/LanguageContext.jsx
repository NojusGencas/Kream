...
export const translations = {
  ...
  en: {
    ...
    about: {
      ...
      specialty1Descript: 'Elegant multi-tiered cakes for your most important day.',
      specialty2: 'Birthday cakes',
      specialty2Descript: 'Colorful and fun cakes for children and adults.',
      specialty3: 'Corporate events',
      specialty3Descript: 'Custom cakes with logos, dessert tables for conferences and celebrations.',
      specialty4: 'Seasonal treats',
      specialty4Descript: 'Special pastries for Christmas, Easter and other holidays.',
